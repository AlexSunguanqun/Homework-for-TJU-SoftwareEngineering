...
public class VW_Activity_2 extends Activity implements OnClickListener{
	/*上下文声明*/
...
//				vLoading.setVisibility(View.INVISIBLE);
			...
			break;
		case R.id.btnShow:
			mIntent=new Intent(mContext, VW_ShowActivity.class);
			startActivity(mIntent);
			
			break;
		case R.id.btnSend:
			mIntent=new Intent(mContext, VW_SendActivity.class);
			startActivity(mIntent);
			
			break;
		case R.id.btnManage:
			mIntent=new Intent(mContext, VW_Activity.class);
			startActivity(mIntent);
