...
public class VW_lActivity extends Activity implements OnClickListener{
	...
	private void initEvent(){
		mContext	=	VW_lActivity.this;
		helper		=	new UB_DBHelper(mContext);
		cExportData	=	new CaneData(mContext, helper);
