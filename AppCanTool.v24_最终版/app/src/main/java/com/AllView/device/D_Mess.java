package com.AllView.device;

import java.util.ArrayList;

public class D_Mess extends D_Data {
	private int _id;
	private String time;
	private String chn;
	private String id;
...
//	private String datas;
	...
	// 含参数的构造函数;
	public D_Mess(int _id, String time, String name, String dir, D_Data meData, String initime, String initdata) {
		super();
		this._id = _id;
		this.time = time;
		this.chn = "no";
	...
	public void setMeData(D_Data meData) {
		this.meData = meData;
	}
