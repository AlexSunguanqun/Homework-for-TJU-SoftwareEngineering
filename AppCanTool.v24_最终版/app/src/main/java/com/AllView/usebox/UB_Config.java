...
/////////		
	private String sql_insert13=
		...
		public UB_Config() {
			listSQlInit=new ArrayList<String>();
			listSQlInit.add(sql_caninfo);
			listSQlInit.add(sql_canmessage);
			listSQlInit.add(sql_cansignal);
			listSQlInit.add(sql_insert01);
			listSQlInit.add(sql_insert01_01);
			listSQlInit.add(sql_insert01_02);
			listSQlInit.add(sql_insert01_03);
			listSQlInit.add(sql_insert01_04);
			listSQlInit.add(sql_insert01_05);
			listSQlInit.add(sql_insert01_06);
			listSQlInit.add(sql_insert01_07);
			listSQlInit.add(sql_insert01_08);
			listSQlInit.add(sql_insert01_09);
			listSQlInit.add(sql_insert01_10);
			listSQlInit.add(sql_insert01_11);
			listSQlInit.add(sql_insert01_12);
			listSQlInit.add(sql_insert01_13);
			listSQlInit.add(sql_insert01_14);
			listSQlInit.add(sql_insert01_15);
			listSQlInit.add(sql_insert01_16);
			listSQlInit.add(sql_insert01_17);
			listSQlInit.add(sql_insert01_18);
			listSQlInit.add(sql_insert01_19);
			listSQlInit.add(sql_insert01_20);
			listSQlInit.add(sql_insert01_21);
			listSQlInit.add(sql_insert01_22);
			listSQlInit.add(sql_insert02);
			listSQlInit.add(sql_insert02_01);
			listSQlInit.add(sql_insert02_02);
			listSQlInit.add(sql_insert02_03);
			listSQlInit.add(sql_insert03);
			listSQlInit.add(sql_insert03_01);
			listSQlInit.add(sql_insert03_02);
			listSQlInit.add(sql_insert03_03);
			listSQlInit.add(sql_insert03_04);
			listSQlInit.add(sql_insert03_05);
			listSQlInit.add(sql_insert03_06);
			listSQlInit.add(sql_insert03_07);
			listSQlInit.add(sql_insert03_08);
			listSQlInit.add(sql_insert04);
			listSQlInit.add(sql_insert04_01);
			listSQlInit.add(sql_insert04_02);
			listSQlInit.add(sql_insert04_03);
			listSQlInit.add(sql_insert04_04);
			listSQlInit.add(sql_insert04_05);
			listSQlInit.add(sql_insert04_06);
			listSQlInit.add(sql_insert04_07);
			listSQlInit.add(sql_insert04_08);
			
			listSQlInit.add(sql_insert05);
			listSQlInit.add(sql_insert05_01);
			listSQlInit.add(sql_insert06);
			listSQlInit.add(sql_insert06_01);
			listSQlInit.add(sql_insert06_02);
			listSQlInit.add(sql_insert07);
			listSQlInit.add(sql_insert07_01);
			listSQlInit.add(sql_insert07_02);
			listSQlInit.add(sql_insert07_03);
			listSQlInit.add(sql_insert07_04);
			listSQlInit.add(sql_insert07_05);
			listSQlInit.add(sql_insert07_06);
			listSQlInit.add(sql_insert08);
			listSQlInit.add(sql_insert08_01);
			listSQlInit.add(sql_insert08_02);
			listSQlInit.add(sql_insert08_03);
			listSQlInit.add(sql_insert08_04);
			listSQlInit.add(sql_insert08_05);
			listSQlInit.add(sql_insert08_06);
			listSQlInit.add(sql_insert08_07);
			listSQlInit.add(sql_insert08_08);
			listSQlInit.add(sql_insert08_09);
			listSQlInit.add(sql_insert08_10);
			listSQlInit.add(sql_insert08_11);
			listSQlInit.add(sql_insert08_12);
			listSQlInit.add(sql_insert08_13);
			listSQlInit.add(sql_insert08_14);
			listSQlInit.add(sql_insert08_15);
			listSQlInit.add(sql_insert08_16);
			listSQlInit.add(sql_insert08_17);
			listSQlInit.add(sql_insert08_18);
			listSQlInit.add(sql_insert08_19);
			listSQlInit.add(sql_insert08_20);
			listSQlInit.add(sql_insert08_21);
			listSQlInit.add(sql_insert09);
			listSQlInit.add(sql_insert09_01);
			listSQlInit.add(sql_insert09_02);
			listSQlInit.add(sql_insert09_03);
			listSQlInit.add(sql_insert09_04);
			listSQlInit.add(sql_insert09_05);
			listSQlInit.add(sql_insert09_06);
			listSQlInit.add(sql_insert09_07);
			listSQlInit.add(sql_insert10);
			listSQlInit.add(sql_insert10_01);
			listSQlInit.add(sql_insert10_02);
			listSQlInit.add(sql_insert10_03);
			listSQlInit.add(sql_insert11);
			listSQlInit.add(sql_insert11_01);
			listSQlInit.add(sql_insert11_02);
			listSQlInit.add(sql_insert11_03);
			listSQlInit.add(sql_insert11_04);
			listSQlInit.add(sql_insert11_05);
			listSQlInit.add(sql_insert11_06);
			listSQlInit.add(sql_insert12);
			listSQlInit.add(sql_insert12_01);
			listSQlInit.add(sql_insert12_02);
			listSQlInit.add(sql_insert12_03);
			listSQlInit.add(sql_insert12_04);
			listSQlInit.add(sql_insert12_05);
			listSQlInit.add(sql_insert12_06);
			listSQlInit.add(sql_insert12_07);
			listSQlInit.add(sql_insert12_08);
			listSQlInit.add(sql_insert13);
			listSQlInit.add(sql_insert13_01);
			listSQlInit.add(sql_insert13_02);
			listSQlInit.add(sql_insert13_03);
			listSQlInit.add(sql_insert13_04);
			listSQlInit.add(sql_insert13_05);
			listSQlInit.add(sql_insert13_06);
			listSQlInit.add(sql_insert13_07);
			listSQlInit.add(sql_messinfo);
			listSQlInit.add(sql_signalinfo);
		}

		public ArrayList<String> getListSQlInit() {
			return listSQlInit;
		}
